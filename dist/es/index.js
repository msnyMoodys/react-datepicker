...
import S from "date-fns/getTime";
...
import B from "date-fns/endOfDay";
...
function Ne(e, t) {
  var r = t.hour,
    ...
    a = void 0 === o ? 0 : o,
    s = t.second;
  return P(M(_(e, void 0 === s ? 0 : s), a), n);
}
function Oe(e, t) {
...
function Ue(e, t) {
  return Pe(E(Se(), e), "LLLL", t);
}
function $e(e, t) {
  return Pe(E(Se(), e), "LLL", t);
}
function ze(e, t) {
  return Pe(N(Se(), e), "QQQ", t);
}
function Ge(e) {
    ...
    function o() {
      ...
      return (
        ...
        le(fe(r), "getTabIndex", function (e, t) {
          ...
          return r.isKeyboardSelected() || (r.isSameDay(n) && We(o, n))
            ? 0
            : -1;
        }),
        ...
        le(fe(r), "renderWeeks", function () {
          for (
            var t = [],
              ...
              o = 0,
              a = !1,
              s = Te(Ie(r.props.day), r.props.locale, r.props.calendarStartDay);
            t.push(
              e.createElement(Pt, {
          ...
          return t(
            ...
            u,
            {
              "react-datepicker__month--disabled":
                (i || c) && Xe(E(o, e), r.props),
              "react-datepicker__month--selected": g(o) === e && C(o) === C(p),
              "react-datepicker__month-text--keyboard-selected": g(l) === e,
        ...
        le(fe(t), "renderTimes", function () {
          for (
            var r = [],
              ...
              c = t.props.selected || t.props.openToDate || Se(),
              l = v(c),
              d = y(c),
              u = P(M(s, d), l),
              h = 0;
    ...
    function o(r) {
      ...
      return (
        ...
        le(
          fe((a = n.call(this, r))),
          "YEAR_REFS",
          De(Array(a.props.yearItemNumber)).map(function () {
            return e.createRef();
          })
        ),
        le(fe(a), "isDisabled", function (e) {
          return Ge(e, a.props);
        }),
        le(fe(a), "isExcluded", function (e) {
          return Je(e, a.props);
        }),
        le(fe(a), "updateFocusOnPaginate", function (e) {
          var t = function () {
            this.YEAR_REFS[e].current.focus();
          }.bind(fe(a));
          window.requestAnimationFrame(t);
        }),
        le(fe(a), "handleYearClick", function (e, t) {
          a.props.onDayClick && a.props.onDayClick(e, t);
        }),
        le(fe(a), "handleYearNavigation", function (e, t) {
          var r = a.props,
            n = r.date,
            o = r.yearItemNumber,
            s = yt(n, o).startPeriod;
          a.isDisabled(t) ||
            a.isExcluded(t) ||
        ...
        le(fe(a), "isSameDay", function (e, t) {
          return We(e, t);
        }),
        le(fe(a), "isKeyboardSelected", function (e) {
          var t = Le(O(a.props.date, e));
          return (
            !a.props.disabledKeyboardNavigation &&
            !a.props.inline &&
            !We(t, Le(a.props.selected)) &&
            We(t, Le(a.props.preSelection))
          );
        }),
        le(fe(a), "onYearClick", function (e, t) {
          var r = a.props.date;
          a.handleYearClick(Le(O(r, t)), e);
        }),
        le(fe(a), "onYearKeyDown", function (e, t) {
          var r = e.key;
          if (!a.props.disabledKeyboardNavigation)
            switch (r) {
              case "Enter":
                ...
                break;
              case "ArrowRight":
                a.handleYearNavigation(t + 1, l(a.props.preSelection, 1));
                break;
              case "ArrowLeft":
                a.handleYearNavigation(t - 1, m(a.props.preSelection, 1));
            }
        }),
        le(fe(a), "getYearClassNames", function (e) {
          var r = a.props,
            n = r.minDate,
            o = r.maxDate,
            s = r.selected;
          return t("react-datepicker__year-text", {
            ...
            "react-datepicker__year-text--disabled": (n || o) && tt(e, a.props),
            "react-datepicker__year-text--keyboard-selected":
              a.isKeyboardSelected(e),
            "react-datepicker__year-text--today": e === C(Se()),
          });
        }),
        le(fe(a), "getYearTabIndex", function (e) {
        ...
        le(fe(a), "header", function () {
          var r =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : a.state.date,
            n = Te(r, a.props.locale, a.props.calendarStartDay),
            o = [];
          return (
          ...
          if (a.props.todayButton && !a.props.showTimeSelectOnly)
            return e.createElement(
              "div",
              {
                ...
                onClick: function (e) {
                  return a.props.onSelect(F(Se()), e);
                },
              },
              a.props.todayButton
            );
      ...
      return (
        ...
        le(fe(s), "handleChange", function () {
          ...
          if (
            ...
            s.setState({ inputValue: n.target.value, lastPreSelectChange: Bt });
            var o = _e(
              n.target.value,
              s.props.dateFormat,
              s.props.locale,
        ...
        le(fe(s), "setSelected", function (e, t, r, n) {
          ...
          if (null === o || !Ge(o, s.props)) {
            var a = s.props,
              ...
              c = a.startDate,
              l = a.endDate;
            if (!Be(s.props.selected, o) || s.props.allowSameDay || i)
              if (
                (null !== o &&
                  (!s.props.selected ||
                    (r &&
